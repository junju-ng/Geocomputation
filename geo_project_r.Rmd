...
## Methods in Violence and Sexual Offences
A spatial point pattern analysis was done on the City of London 001F LSOA. 

The process is as follows: 

1. Test if point pattern is homogeneous: Quadrat Counting
  Point process was found to be non-homogeneous hence, Kernel Density Estimation was employed to identify      areas with high intensity. 
2. Identify high intensity areas: Kernel Density Estimation 
  Hypothesis: VSO crimes correlate with locations of entertainment outlets (pubs, bars & restaurants)
3. Test hypothesis: Inhomogeneous K cross function
